<template>
  <div>
    ...
    <div style="margin-bottom:40px;">I'm looking for a job !<br />Feel free to contact me about any opportunity, or just
      to chat about video games, food or anything else.</div>
    ...
    <ul>
      ...
      <li>
        ...
        <a href="https://www.linkedin.com/in/joshua-coss-a693a91ba/" target="_blank">LinkedIn</a>
      </li>
      <li>
        <i class="fa fa-github fa-lg fa-fw"></i>
        <a href="https://github.com/joshualeecoss" target="_blank">GitHub</a>
      </li>
      <li>
